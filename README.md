...
`emustarter.py` let's you select one of several systems and the game you want to play on the Linux console, and ideally it handles the rest of the configuration and just starts the game. 
