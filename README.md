...
- Zur Joystick-Konfiguration:
  ...
  - Zeigt der Feuerknopf keine Wirkung, geht man im F1-Menü in `Controller Configuration / Configure real joysticks / Joystick 1 / Configure Buttons`, und setzt unter `A` die Option `Action / Joy Trigger`. Dann speichert man die Konfiguration unter `Emulator Configuration / Save configuration file` ab.
